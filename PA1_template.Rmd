...
This interval-wise mean has been calculated above in the data frame 'timeseriesdata' and will be used to impute the missing values.  The `r nrow(timeseriesdata)` values in the data frame will be repeated 8 times to impute the `r length(data$steps[!complete.cases(data)])` missing values.
